...
function player.load()
    ...
    if successRobo and player.anim8 then
        ...
        player.animations = {}
        -- row 1: gun animations (walk 3-5, dash 6)
        player.animations.gun = {}
        player.animations.gun.walk = player.anim8.newAnimation(player.grid('3-5', 1), 0.15)
        player.animations.gun.dash = player.anim8.newAnimation(player.grid('6-6', 1), 0.15)
        
        -- row 2: melee/knife animations (walk 3-5, dash 6)
        player.animations.melee = {}
        player.animations.melee.walk = player.anim8.newAnimation(player.grid('3-5', 2), 0.15)
        player.animations.melee.dash = player.anim8.newAnimation(player.grid('6-6', 2), 0.15)
